...
## 7. `[NEEDS CLARIFICATION]` — pendientes para `/nxt-ai.clarify`

| ID | Pregunta | Bloquea |
|---|---|---|
| NC-1 | ¿Cuántos integrantes tiene el equipo? | AC-3.1, `steering/product.md` § Lista de integrantes |
| NC-2 | ¿"Actividad individual" del título del .docx aplica o es trabajo de equipo según rúbrica? | NC-1, alcance global |
| NC-3 | ¿El problema base del rover cuenta como uno de los "3 problem.pddl" o son 3 adicionales al base? | Cantidad de escenarios alternativos |
| NC-4 | ¿Capacidad de carga del rover: 1 mineral a la vez, ilimitada, parámetro N? | ADR-001, modelado de `domain.pddl` |
| NC-5 | ¿Función de costo: unitario por acción o ponderado? | ADR-002, criterio "óptimo" del planner |
| NC-6 | ¿Fecha de entrega de la actividad? | Hitos H1-H6 |
| NC-7 | ¿Existe restricción de tamaño de equipo / formato de presentación adicional al .docx? | Alcance |
